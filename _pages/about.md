...
I am currently an Assistant Project Scientist at the University of California, Berkeley, where my research focuses on computational seismology and the Distributional Finite Difference Method (DFDM) for seismic wave propagation. I work on developing and benchmarking DFDM solvers for wave equations, with applications to understanding seismic wave behavior in complex geological structures and earth interior.
